...
def floor_div(args):
    ...
    if args.rest == nil:
        ...
        div1 = calc_eval((args.first))
        div2 = calc_eval((args.rest.first))
        assert isinstance(div1, int) and isinstance(div2, int)
        return floor_div(Pair(div1 // div2, args.rest.rest))
